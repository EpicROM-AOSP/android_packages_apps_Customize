...
import com.epic.settings.preferences.CustomSeekBarPreference;
...
public class Wallpaper extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.epic_settings_wallpaper);
    ...
    public int getMetricsCategory() {
        return MetricsProto.MetricsEvent.EPİC;
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.epicrom _settings_wallpaper) {
