/*
 * Copyright (C) 2023-2025 The EpicROM-AOSP Project
 * SPDX-License-Identifier: Apache-2.0
 */

package com.epic.settings.fragments.themes;
...
import com.epic.settings.preferences.GlobalSettingListPreference;
import com.epic.settings.preferences.SystemSettingListPreference;
import com.epic.settings.utils.DeviceUtils;
import com.epic.settings.utils.SystemRestartUtils;
import com.epic.settings.utils.SystemUtils;
...
public class Themes extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.epic_settings_themes);
        ...
        if (!Utils.isPackageInstalled(context, "com.epic.udfps.icons")) {
                 mIconsCategory.removePreference(mUdfpsIcon);
             }
            if (!Utils.isPackageInstalled(context, "com.epic.udfps.animations")) {
                mAnimationsCategory.removePreference(mUdfpsAnimation);
            }
        }
    ...
    public int getMetricsCategory() {
        return MetricsEvent.EPİC;
    }

    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        new BaseSearchIndexProvider(R.xml.epic_settings_themes) {
